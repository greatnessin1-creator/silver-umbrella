...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(1200px_circle_at_20%_10%,hsl(var(--gold-soft)/0.35),transparent_55%),radial-gradient(900px_circle_at_80%_30%,hsl(var(--rose)/0.25),transparent_60%)]" />
      ...
      <div className="relative mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start">
            ...
            >
              <motion.p
                custom={0}
                variants={fadeUp}
                className="font-body text-xs sm:text-sm tracking-[0.2em] uppercase text-[hsl(var(--gold))]"
              >
                Premium Body Care
              </motion.p>
              ...
              >
                ...
                <span className="italic text-[hsl(var(--gold))]">Self-Care</span>
              </motion.h1>
              ...
              <motion.div custom={3} variants={fadeUp} className="flex flex-col sm:flex-row gap-3 mt-2">
                ...
                <Button
                  ...
                  variant="outline"
                  className="border-[hsl(var(--gold)/0.35)] text-[hsl(var(--foreground))] hover:bg-[hsl(var(--gold-soft)/0.35)] rounded-xl px-8 py-6 text-sm font-body font-medium tracking-wide transition-all duration-200 active:scale-[0.98]"
                  onClick={() => {
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <RefreshCcw className="w-4 h-4 text-[hsl(var(--gold))]" strokeWidth={1.5} />
                  <span>30-Day Satisfaction</span>
                </div>
                <div className="flex items-center gap-2">
                  <Shield className="w-4 h-4 text-[hsl(var(--gold))]" strokeWidth={1.5} />
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-[0_20px_60px_-20px_rgba(20,16,12,0.3)] border border-[hsl(var(--gold)/0.15)]">
              <img
              ...
              />
              {/* Gold corner accent */}
              <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-[hsl(var(--gold)/0.15)] to-transparent" />
              <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-tr from-[hsl(var(--gold)/0.1)] to-transparent" />
            </div>
          </motion.div>
        </div>
      </div>
