      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
          {benefits.map((benefit, index) => (
            ...
            >
              <Card className="group rounded-2xl bg-[hsl(var(--card))] border border-[hsl(var(--border))] shadow-[0_10px_30px_-18px_rgba(20,16,12,0.35)] transition-all duration-300 hover:border-[hsl(var(--gold)/0.35)] hover:shadow-[0_18px_50px_-26px_rgba(20,16,12,0.45)] h-full">
                <CardContent className="p-6 sm:p-8 text-center">
                  <div className="w-14 h-14 rounded-full bg-[hsl(var(--gold-soft))] flex items-center justify-center mx-auto mb-5 transition-colors duration-300 group-hover:bg-[hsl(var(--gold)/0.25)]">
                    <benefit.icon className="w-6 h-6 text-[hsl(var(--gold))]" strokeWidth={1.5} />
                  </div>
